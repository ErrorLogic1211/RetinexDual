...
from basicsr.utils import (MessageLogger, check_resume, get_env_info,
                           ...
                           set_random_seed,rgb2lab,lab2rgb)
...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        '-opt', type=str,default='./Enhancement/Options/Enhancement_MIRNet_v2_shadow.yml', help='Path to option YAML file.')
...
def main():
    ...
    # automatic resume ..
    state_folder_path = os.path.join(opt['path'].get('experiments_root'), 'training_states')
    # state_folder_path = '/mnt/data0/experiments/{}/training_states/'.format(opt['name'])
